...
<head>
	...
	<div class="col-xs-8 col-xs-offset-2 col-md-6 col-md-offset-3 container">
		...
		<h1 class="content-header sec-text">Edit About Page</h1>
			<hr class="small sec-text" id="society-hr">
	</div>
	</section>

	<div class="container" id="admin_editabout">

	<section class="whitebox admin" id="editabout">

<h1 class="text-center">Edit About Page</h1>
